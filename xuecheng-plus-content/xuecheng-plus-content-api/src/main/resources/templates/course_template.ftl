...
<div id="learningArea">
                    ...
                    <div class="article-left-box">
                        <div class="content">
                            <div class="content-title">
                                ...
                                <p><a class="all">全部</a><span><a>1.1</a><a>1.2</a><a>1.3</a><a>1.4</a><a>1.5</a></span><a href="$" class="more">更多 <i class="i-chevron-bot"></i></a>
                                </p>
                            </div>
                            <div class="item">
                                <div class="item-left">
    ...
    <div class="popup-box">
        ...
        <div class="popup-pay-box">
            ...
            <div class="go-pay"><a href="#" @click.prevent="wxPay()">微信支付</a><a href="#" @click.prevent="aliPay()">支付宝支付</a><a href="#" @click.prevent="querypayresult()">支付完成</a><a
...
<script>var courseId = "${model.courseBase.id}";
    var courseCharge = "${mode.courseBase.charge}"</script>
