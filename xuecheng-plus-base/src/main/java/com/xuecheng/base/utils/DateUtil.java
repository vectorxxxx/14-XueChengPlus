...
public class DateUtil
{
    ...
    public static LocalDateTime localDateTimeAddMonth(LocalDateTime date, int increase) {
        ...
        // LocalDateTime <-- Date
        return LocalDateTime.ofInstant(cal
                .getTime()
    ...
    /**
     * 功能：<br/> 根据时间 yyyy-MM-dd 获取该日期是本月第几周
     */
    ...
    public static final int getSecondToDesignationTime(String designationTime) {
        ...
        try {
            ...
            int u = (int) ((toDate.getTime() - dateFormat
                    .parse(DateUtil.getCurrDateTimeStr())
                    .getTime()) / 1000);
            return u;
        }
        catch (ParseException e) {
